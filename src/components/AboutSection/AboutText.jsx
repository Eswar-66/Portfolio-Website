  ...
  return (
    <div className='flex flex-col md:items-start sm:items-center md:text-left sm:text-center '>
        ...
        <div className="flex gap-4 justify-center items-center">
          ...
          <a
            href="/Eswar's_Resume.pdf" 
            download
            className='ursor-pointer text-white hover:text-cyan transition-all duration-500'
          >
            <button className='bg-cyan-400 border-4 border-white rounded-full mt-5 py-2 px-4 cursor-pointer hover:bg-amber-300 active:bg-amber-600 transition-all duration-400 md:self-start sm:self-center'>
              Download Resume
            </button>
          </a>
        </div>
